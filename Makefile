#############################################################################
# Makefile for building: Sniffer
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 9? 21 21:17:32 2014
# Project:  Sniffer.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile Sniffer.pro
#############################################################################
...
Makefile: Sniffer.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Sniffer1.0.0 || $(MKDIR) .tmp/Sniffer1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Sniffer1.0.0/ && $(COPY_FILE) --parents include/mainwindow.h include/sniffer.h .tmp/Sniffer1.0.0/ && $(COPY_FILE) --parents src/main1.cpp src/sniffer.cpp src/mainwindow.cpp .tmp/Sniffer1.0.0/ && (cd `dirname .tmp/Sniffer1.0.0` && $(TAR) Sniffer1.0.0.tar Sniffer1.0.0 && $(COMPRESS) Sniffer1.0.0.tar) && $(MOVE) `dirname .tmp/Sniffer1.0.0`/Sniffer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Sniffer1.0.0
...
moc_mainwindow.cpp: include/mainwindow.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) include/mainwindow.h -o moc_mainwindow.cpp
...
main1.o: src/main1.cpp include/sniffer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main1.o src/main1.cpp

sniffer.o: src/sniffer.cpp include/sniffer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sniffer.o src/sniffer.cpp
